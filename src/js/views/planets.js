            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col-12">
                        <span className="container-title text-gradient text-center mt-5"> PLANETS </span>
                    </div>
                </div>
                            ...
                            <div key={index} className="col-md-4 col-sm-6 col-12 mb-3">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div>
                                            <p className="card-text"><b>Climate:</b> {item.result.properties.climate}</p>
                                            <p className="card-text"><b>Diameter:</b> {item.result.properties.diameter}</p>
                                            <p className="card-text"><b>Terrain:</b> {item.result.properties.terrain}</p>
                                        </div>
