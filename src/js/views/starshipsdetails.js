        ...
        <div className="row g-0 d-flex flex-row-reverse">
          ...
          <div className="col-md-6">
            <div className="card-body">
              ...
              <p className="card-text-description mt-4"><b>Description: </b><br />{selectedStarships.result.properties.name} Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, 
