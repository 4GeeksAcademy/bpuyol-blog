            ...
            <div className="container mt-5">
                <div className="row">
                    <div className="col-12">
                        <span className="container-title text-gradient text-center mt-5"> STARSHIPS </span>
                    </div>
                </div>
                            ...
                            <div key={index} className="col-md-4 col-sm-6 col-12 mb-3">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div>
                                            <p className="card-text"><b>Cost:</b> {item.result.properties.cost_in_credits}</p>
                                            <p className="card-text"><b>Length:</b> {item.result.properties.length}</p>
                                            <p className="card-text"><b>Passengers:</b> {item.result.properties.passengers}</p>
                                        </div>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            ...
                                            <button
                                                type="button"
                                                className={`btn ${store.favorites.includes(item.result.properties.name) ? 'btn-warning' : 'btn-outline-warning'} mt-2`}
                                                onClick={() => {
